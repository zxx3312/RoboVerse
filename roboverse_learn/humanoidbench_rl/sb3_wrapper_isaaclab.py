...
class Sb3EnvWrapperIsaaclab(VecEnv):
    ...
    def step_wait(self):
        ...
        # For IsaacLab, metasim_reward is None
        ...
        for reward_func, reward_weight in zip(
            ...
            final_reward += reward_func(self.env.handler.robot.name)(self.env.handler.get_states()) * reward_weight
        metasim_reward = final_reward
...
def check_metasim_env(sim_type: SimType = SimType.ISAACGYM, num_envs: int = 2):
    ...
    env = Sb3EnvWrapperIsaaclab(scenario)
