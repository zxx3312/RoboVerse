...
json_filenames = sorted(os.listdir("roboverse_data/assets/arnold/reorient_object_merged_pickle"))
...
for filename in json_filenames:
    ...
    name = f"ArnoldReorientObject{object_id}{get_scale_friendly_name(scale)}Target{target}Cfg"
    code = f"""@configclass
