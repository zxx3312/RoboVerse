...
@configclass
class LiberoPickOrangeJuiceCfg(BaseTaskCfg):
    """Configuration for the Libero pick orange juice task.
    ...
    episode_length = 250
    task_language = "Pick the orange juice and place it in the basket"
    ...
    traj_filepath = "roboverse_data/trajs/libero/pick_up_the_orange_juice_and_place_it_in_the_basket/v2"
