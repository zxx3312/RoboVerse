"""Carry config in SkillBench in Skillblender"""
...
@configclass
class TaskCarryCfgPPO(BaseHumanoidCfgPPO):
    seed = 5
...
@configclass
class TaskCarryCfg(BaseHumanoidCfg):
    """Cfg class for Skillbench:Carry."""

    task_name = "task_carry"
    env_spacing = 5.0
    decimation = 10
