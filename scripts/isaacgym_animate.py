...
- Feishi Wang
- 2025-04-17
- Please view the usage using: python isaacgym_animate.py --help
"""
...
args = gymutil.parse_arguments(
    ...
    custom_parameters=[
        {"name": "--file", "type": str, "default": None, "help": "Path to the URDF or MJCF file"},
        {"name": "--speed_scale", "type": float, "default": 1.0, "help": "Animation speed scale"},
        {"name": "--show_axis", "action": "store_true", "help": "Visualize DOF axis"},
        {"name": "--flip_visual_attachments", "action": "store_true", "help": "Flip visual attachments"},
    ],
)
...
# load asset
asset_root = os.path.dirname(args.file)
asset_file = os.path.basename(args.file)

asset_options = gymapi.AssetOptions()
asset_options.fix_base_link = True
asset_options.flip_visual_attachments = args.flip_visual_attachments
